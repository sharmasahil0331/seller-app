...
class OndcController {
  ...
  orderSelect(req, res, next) {
    ...
    ondcService
      .orderSelect(req.body, req)
      .then((data) => {
        console.log(
          "🚀 ~ file: ondc.controller.js:22 ~ OndcController ~ orderSelect ~ data:",
          data
        );
  ...
  orderStatusUpdate(req, res, next) {
    console.log("🚀 ~ file: ondc.controller.js:92 ~ OndcController ~ orderStatusUpdate ~ req:")
    // const currentUserAccessToken = res.get('currentUserAccessToken');
      
    ondcService
      .orderStatusUpdate(req.body, req)
      .then((data) => {
        res.json(data);
      })
      .catch((err) => {
  ...
  orderStatusUpdateItems(req, res, next) {
    // const currentUserAccessToken = res.get('currentUserAccessToken');
    ondcService
      .orderStatusUpdateItems(req.body, req)
      .then((data) => {
        res.json(data);
      })
      .catch((err) => {
  ...
  orderCancelFromSeller(req, res, next) {
    // const currentUserAccessToken = res.get('currentUserAccessToken');
    ondcService
      .orderCancelFromSeller(req.body, req)
      .then((data) => {
        res.json(data);
      })
      .catch((err) => {
