...
const apiUrl =
  ...
  (nconf.get("express").useFqdnForApis
    ? nconf.get("express").fqdn
    : nconf.get("express").ipAddress) +
  ":" +
...
if (env !== "development") {
  ...
  nconf.set(
    "sellerConfig:LOGISTICS_DELIVERY_TYPE",
    process.env.LOGISTICS_DELIVERY_TYPE
  );
