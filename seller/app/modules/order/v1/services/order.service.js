...
class OrderService {
    ...
    async list(params) {
        console.log("🚀 ~ file: order.service.js:76 ~ OrderService ~ list ~ params:", params)
        try {
            let query={};
            if(params.organization){
                query.organization =params.organization;
            ...
            console.log(
              "🚀 ~ file: order.service.js:78 ~ OrderService ~ list ~ query:",
              query
            );
            ...
            console.log("🚀 ~ file: order.service.js:87 ~ OrderService ~ list ~ data:", data)
